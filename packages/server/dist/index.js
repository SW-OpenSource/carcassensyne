...
const databaseUrl = 'mongodb://localhost:27017/shoppingbuddy'; // process.env.NODE_ENV === 'development'
//   ? 'mongodb://localhost:27017/shoppingbuddy'
//   : `mongodb://${DB_USER}:${DB_PASS}@ds257241.mlab.com:57241/listawesome`

const {
  ObjectId
} = mongoose.Types; // eslint-disable-next-line func-names
